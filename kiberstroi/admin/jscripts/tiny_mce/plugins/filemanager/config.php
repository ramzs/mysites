<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../../../uploads/files/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../../../uploads/files/'; // absolute or relative from this script path.
