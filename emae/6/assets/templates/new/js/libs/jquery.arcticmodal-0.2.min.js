...
(function (d) {
    var g = {type: "html", content: "", url: "", ajax: {}, ajax_request: null, closeOnEsc: !0, closeOnOverlayClick: !0, clone: !1, overlay: {block: void 0, tpl: '<div class="arcticmodal-overlay"></div>', css: {backgroundColor: "#000", opacity: 0.6}}, container: {block: void 0, tpl: '<div class="arcticmodal-container"><table class="arcticmodal-container_i"><tr><td class="arcticmodal-container_i2"></td></tr></table></div>'}, wrap: void 0, body: void 0, errors: {tpl: '<div class="arcticmodal-error arcticmodal-close"></div>', autoclose_delay: 2E3,
        ajax_unsuccessful_load: "Error"}, openEffect: {type: "fade", speed: 400}, closeEffect: {type: "fade", speed: 400}, beforeOpen: d.noop, afterOpen: d.noop, beforeClose: d.noop, afterClose: d.noop, afterLoading: d.noop, afterLoadingOnShow: d.noop, errorLoading: d.noop}, i = 0, e = d(), l = {isEventOut: function (a, b) {
        var c = !0;
        d(a).each(function () {
        ...
        return c
    }}, f = {transition: function (a, b, c, e) {
        e = void 0 == e ? d.noop : e;
        switch (c.type) {
            case "fade":
                "show" ==
                    b ? a.fadeIn(c.speed, e) : a.fadeOut(c.speed, e);
                break;
            case "none":
                "show" == b ? a.show() : a.hide(), e()
        }
    }, prepare_body: function (a, b) {
        d(".arcticmodal-close", a.body).click(function () {
            b.arcticmodal("close");
            return!1
        })
        ...
        if (!c) {
            ...
            b.clone ? c.body.html(a.clone(!0)) : (a.before('<div id="arcticmodalReserve' +
                c.modalID + '" style="display: none" />'), c.body.html(a));
            f.prepare_body(c, a);
            c.closeOnOverlayClick && c.overlay.block.add(c.container.block).click(function (b) {
                l.isEventOut(d(">*", c.body), b) && a.arcticmodal("close")
            });
            ...
            var m =
                d.extend(!0, {url: c.url, beforeSend: function () {
                    void 0 == j ? c.body.html('<div class="arcticmodal-loading" />') : j(c, a)
                }, success: function (b) {
                    ...
                    c.errorLoading(c, a);
                    void 0 == k ? (c.body.html(c.errors.tpl), d(".arcticmodal-error", c.body).html(c.errors.ajax_unsuccessful_load), d(".arcticmodal-close", c.body).click(function () {
                        a.arcticmodal("close");
                        return!1
                    }), c.errors.autoclose_delay && setTimeout(function () {
                        a.arcticmodal("close")
                    }, c.errors.autoclose_delay)) : k(c, a)
                }}, c.ajax);
            c.ajax_request = d.ajax(m);
            a.data("arcticmodal", c)
        }
    }, init: function (a) {
        a = d.extend(!0, {}, g, a);
        ...
        var a = d(this), b = a.data("arcticmodal");
        if (b) {
        ...
        d.error("jquery.arcticmodal: Uncorrect call")
    }, close: function () {
        if (d.isFunction(this))e.each(function () {
            ...
            var a = d(this), b = a.data("arcticmodal");
            b ? !1 !== b.beforeClose(b, a) && (a.trigger("beforeClose"), e.not(a).last().each(function () {
            ...
            }), "ajax" == b.type && b.ajax_request.abort(), e = e.not(a)) : d.error("jquery.arcticmodal: Uncorrect call")
        })
    ...
    d(document).bind("keyup.arcticmodal", function (a) {
        var b = e.last();
        b.length &&
            b.data("arcticmodal").closeOnEsc && 27 === a.keyCode && b.arcticmodal("close")
    });
